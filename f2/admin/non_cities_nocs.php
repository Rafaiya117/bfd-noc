    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body" style="border:1px solid #5a6d91; box-sizing:border-box; background-color:#E5E4E2;">
                <h4 class="header-title mb-3" style="text-align:center;"><i class="fas fa-file-import"></i>&nbsp;<a href="non_cities_import/all_list.php" >Import</a></h4>
                    <div class="inbox-widget"></div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card"> 
                                        <div class="card-body" style="border:1px solid #5a6d91; box-sizing:border-box; background-color:#E5E4E2;">
                                    <h4 class="header-title mb-3" style="text-align:center;"><i class="fas fa-file-export"></i>&nbsp;<a href="non_cities_export/all_list.php">Export</a></h4>
                                <div class="inbox-widget"></div>
                            </div>
                        </div> 
                    </div><!-- end col -->
