...
function view_species_table_v2($NOC, $species_on_this_noc, $edit=false){
    ...
    for ($i = 0, $ilen = sizeof($species_on_this_noc); $i < $ilen; $i += 1) {
        ...
        echo '<tr><th class="inner-th"> Source </th><td class="inner-td"> ',strtoupper($one_s['source']),' </td></tr>';
        echo '</table>';
        echo '</td>';
        // Quantity
      ...
      echo '<td class="td-wp-table">'; 
        ...
        echo '<tr><td> BDT </td><td class="tk"> ',$one_s['price_bdt'],' </td><td class="tk"> ',$one_s['price_bdt']*  $one_s['quantity'],' </td></tr>';
        echo '</table>';
        echo '</td>';
